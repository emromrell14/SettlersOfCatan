...
public class TurnTrackerView extends PanelView implements ITurnTrackerView {
	...
	public void updatePlayer(int playerIndex, int points, boolean highlight,
		...
		{
			c.setBackground(playerColor.getJavaColor());
		}
	...
	@Override
	public void updateGameState(CatanColor color, String stateMessage, boolean enable) {

		gameStatePanel.updateGameState(color, stateMessage, enable);
	}

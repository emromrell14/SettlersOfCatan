...
public class PlayerTester 
{
	...
	public void testCanAffordRoad()
	{
		...
		System.out.println("Testing build road after I've already built 14 (Should pass)");
		//Can I still play one (I have 1 more road left)
		assertTrue(playerZero.canAffordRoad());
		System.out.println("PASSED");		
		
		System.out.println("Testing build road after I've already built 15 (Should fail)");
	...
	public void testCanPlaceRoad()
	{
		...
		System.out.println("Testing placing on an empty board (Should fail - no settlements");
		//Can you place a road on an empty board?
		assertFalse(playerZero.canPlaceRoad(new EdgeLocation(hex00, EdgeDirection.North)));
		System.out.println("PASSED");

		System.out.println("Testing place road next to another road (On various edges)");
		...
		System.out.println("Testing place road where another already exists (Should fail)");
		...
		System.out.println("Testing using a different address for the same edge (Should also fail)");
		...
		System.out.println("Testing place road on same hex but not attached to your road (should fail)");
	...
	public void testCanPlaceRoadFirstOrSecondRound()
	{
		...
		System.out.println("Testing place road next to settlement (Should succeed)");
		...
		System.out.println("Testing place road not next to settlement (First Round - Should fail)");
	...
	public void testCanAffordSettlement()
	{
		...
		System.out.println("Testing build settlement with no resources (Should fail)");
		//Can I build a settlement when I have no resources?
		assertFalse(playerTwo.canAffordSettlement());
		System.out.println("PASSED");

		System.out.println("Testing build settlement with just brick and wheat (Should fail)");
		//Can I build a settlement if I have just brick and wheat?
		playerTwo.addResourcesToList(1, 0, 0, 1, 0);
		assertFalse(playerTwo.canAffordRoad());
		System.out.println("PASSED");

		System.out.println("Testing build settlement with brick, sheep, wheat, and wood (Should succeed)");
		...
		System.out.println("Testing build another settlement after spending all resources on previous one (Should fail)");
		...
		System.out.println("Testing can build settlement with only 1 settlement left to build (Should succeed)");
		//Can I still play one (I have 1 more road left)
		assertTrue(playerZero.canAffordSettlement());
		System.out.println("PASSED");

		System.out.println("Testing can build settlement after building all 5 settlements (Should fail)");
		//How about if I build one more road? (And I don't have any more in my inventory)
		playerZero.buildSettlement(null);
	...
	public void testCanPlaceSettlement()
	{
		...
		System.out.println("Testing place settlement on an empty board (Should fail)");
		...
		System.out.println("Testing place settlement on a board after second round (Should succeed)");
		...
		System.out.println("Testing place settlement on vertex connected by roads (Should succeed)");
		...
		System.out.println("Testing place settlement on vertex not connected by roads (Should fail)");
		...
		System.out.println("Testing from a different direction) (Should succeed)");
	...
	public void testCanAffordCity()
	{
		...
		System.out.println("Testing afford city with no resources (Should fail)");
		//Can I afford a city with no resources?
		assertFalse(playerTwo.canAffordCity());
		System.out.println("PASSED");
		
		System.out.println("Testing afford city with 2 wheat and 2 ore (Should fail)");
		//Can I afford a city with 2 wheat and 2 ore?
		playerTwo.addResourcesToList(0, 2, 0, 2, 0);
		assertFalse(playerTwo.canAffordCity());
		System.out.println("PASSED");
		
		System.out.println("Testing afford city with 2 wheat and 3 ore but without a settlement (Should fail)");
		//Can I afford a city with 2 wheat and 3 ore? (but I haven't built a settlement yet)
		playerTwo.addResourcesToList(0,1,0,0,0);
		assertFalse(playerTwo.canAffordCity());
		System.out.println("PASSED");
		
		System.out.println("Testing build city, having a settlement already (Should succeed)");
		...
		System.out.println("Testing build city with one left to build (Should succeed)");
		//Can I still build a city? (I have one left in my inventory)
		assertTrue(playerZero.canAffordCity());
		System.out.println("PASSED");
		playerZero.buildCity(vertex);
	
		System.out.println("Testing build city with 4 cities already built (Should fail)");
		//Now can I build one? (I have used them all up)
		assertFalse(playerZero.canAffordCity());
		System.out.println("PASSED");

		System.out.println("Testing if all settlements were replenished (Should be, after turning them into cities)");
	...
	public void testCanPlaceCity()
	{
		...
		System.out.println("Testing place city on empty board (Should fail)");
		...
		System.out.println("Testing place city next to roads but not on a settlement (Should fail)");
		...
		System.out.println("Testing place city next to roads and on a settlement (Should succeed)");
		...
		System.out.println("Tetsing place city on top of an existing city (Should fail)");
	...
	public void canPlayDevCard()
	{
		...
		//Assert Trues
		System.out.println("Testing canPlayMonument");
		assertTrue(playerZero.canPlayMonument());
		System.out.println("PASSED");
		System.out.println("Testing canPlayMonopoly");
		assertTrue(playerOne.canPlayMonopoly());
		System.out.println("PASSED");
		System.out.println("Testing canPlayYearOfPlenty");
		assertTrue(playerTwo.canPlayYearOfPlenty());
		System.out.println("PASSED");
		System.out.println("Testing canPlaySoldier");
		assertTrue(playerThree.canPlaySoldier());
		System.out.println("PASSED");
		System.out.println("Testing canPlayRoadBuilder");
		assertTrue(playerThree.canPlayRoadBuilder());
		System.out.println("PASSED");
		
		//Assert False
		System.out.println("Testing canPlayRoadBuilder again (Should fail)");		
		assertFalse(playerZero.canPlayRoadBuilder());
		System.out.println("Testing canPlaySoldier again (Should fail)");		
		assertFalse(playerOne.canPlaySoldier());
		System.out.println("Testing canPlayMonopoly again (Should fail)");		
		assertFalse(playerTwo.canPlayMonopoly());
		System.out.println("Testing canPlayMonument again (Should fail)");		
		assertFalse(playerTwo.canPlayMonument());
		System.out.println("Testing canPlayYearOfPlenty again (Should fail)");		
